...
const TransactionModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-[23rem] bg-white border border-onyx rounded-[0.625rem] drop-shadow-container backdrop-blur-sm py-8 px-6 text-white">
        <DialogHeader>
        ...
        <div className="text-white">
          ...
          <div className="bg-secondary-700 mt-4 text-white text-xs lg:text-sm px-4 rounded py-[0.4375rem] flex items-start space-x-1">
